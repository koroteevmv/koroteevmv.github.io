...
feature_row_certs:
  ...
  - image_path: "/assets/images/certs/ethics.jpg"
    title: "An Introduction to Interactive Programming in Python" 
...
1. Образовательные программы кафедры занимают ведущие места в национальных рейтингах качества образования и востребованности выпускников.
...
С сентября 2025 - **директор Центра цифровой трансформации и искусственного интеллекта** Финансового университета.

* Координация работ по актуализации образовательной программы топ-уровня в сфере ИИ.
* Административное сопровождение функционирования Центра.
* Взаимодействие Центра с Аналитическим Центром при Правительстве РФ.
* Взаимодействие Центра с индустриальными партнерами образовательной программы топ-уровня.
