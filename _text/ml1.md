...
{% capture notice-2 %}
Выводы:
1. Регрессия - это модель, которая принимает набор значений и выдает предсказание значения целевой переменной.
...
#### Как работает метод машинное обучение "на пальцах"?
